...
import { getAllFood } from "../redux/foodListReducer";
        ...
        return (
            <div className="relative flex h-screen w-screen">
                ...
                >
                    ...
                    <div className="flex gap4 height-frame">
                        ...
                        <div className="w-[85%]">
                            ...
                            <div className="h-[80%]">
                                <div className="h-full px-[3vw] overflow-y-auto">
...
const mapDispatchToProps = { toggleSidebar, getAllFood };
